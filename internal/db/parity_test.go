...
var (
	...
	expectedAccountMediaUserColumns          = []string{"account_id", "created_at", "media_server_id", "media_user_id", "source", "updated_at", "username"}
