...
var (
	...
	expectedWatchColumns                     = []string{"active_seconds", "client", "created_at", "device_id", "device_name", "ended_at", "episode_number", "id", "item_id", "item_name", "item_type", "last_position_ms", "last_seen_at", "library_id", "library_name", "media_server_id", "media_user_id", "play_method", "season_number", "series_name", "server_session_id", "source", "started_at", "state", "stream_audio_channels", "stream_audio_codec", "stream_bitrate", "stream_container", "stream_framerate_hundredths", "stream_height", "stream_is_audio_direct", "stream_is_video_direct", "stream_transcode_reasons", "stream_video_codec", "stream_width", "updated_at", "username"}
	expectedWatchSegmentColumns              = []string{"ended_at", "source", "started_at", "watch_id"}
	expectedWatchPositionColumns             = []string{"observed_at", "paused", "play_method", "position_ms", "source", "stream_audio_channels", "stream_audio_codec", "stream_bitrate", "stream_container", "stream_framerate_hundredths", "stream_height", "stream_is_audio_direct", "stream_is_video_direct", "stream_transcode_reasons", "stream_video_codec", "stream_width", "watch_id"}
