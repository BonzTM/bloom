...
| `src/features/auth/`              | sign-in and sign-out: wire schemas mirrored from OpenAPI, API slice, the session query with its roles and permissions and principal-scoped cache clearing, login form, session controls |
